...
for(var i=0; i<characters.length;i++){
	...
	charObjects[characters[i]].picture="assets/images/" + characters[i].toLowerCase() + ".jpg"; //sets path for picture of character
	charObjects[characters[i]].backgroundImage="assets/images/" + characters[i].toLowerCase() + " background.jpg";//sets path for background picture for background
	charObjects[characters[i]].victoryPic="assets/images/" + characters[i].toLowerCase() + "_victory.jpg";//sets path for victory picture for character
	charObjects[characters[i]].sound_attack="assets/sounds/" + characters[i].toLowerCase() + "_attack.mp3";//sets path for attack sound for character
	charObjects[characters[i]].sound_greeting="assets/sounds/" + characters[i].toLowerCase() + "_greeting.mp3";//sets path for greeting sound for character
